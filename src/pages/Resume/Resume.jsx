    ...
    <div className="resume-container">
      ...
      <div className="resume-body-container border w-screen rounded-xl flex flex-col items-center bg-gray-800 pt-7">
        ...
        <div className="flex flex-row mb-5">
          ...
          <a
            className="text-gray-100"
            href="https://jonjacksondev.netlify.app/"
          >
            Portfolio
          </a>
        </div>
        ...
        <div className="brand-statement-section mb-3">
          <p className="text-gray-100">
            ...
            fast-paced sales and marketing environment which I believe gave me
            an ability to see product development with a business-growth
            perspective and the ability to relate to customers. Additionally, I
            am an extremely active listener with experience in leadership,
            creativity, problem solving, and building projects from ideation to
            execution.
          </p>
        </div>
        {/* SUMMARY */}
        <div className="summary-section mb-3">
          ...
          <ul className="list-disc text-gray-100">
            <li className="text-gray-100">
              ...
              engineering in large-scale applications that are used by millions
        ...
        <div className="recent-projects-section mb-3">
          ...
          <div className="recent-project-container mb-5">
            ...
            <p className="text-gray-100 italic">
              A simple E-Commerce frontend application with standard cart
              features and payment processing.
            </p>
            <p className="text-gray-100">
              <span className="text-gray-100">Technologies:</span> ReactJS,
              Redux, Redux-Saga, Firebase, SASS, Typescript, Styled Components,
              Stripe
            </p>
            <p className="text-gray-100">
